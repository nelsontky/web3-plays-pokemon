...
import { TURBO_AB_PRESS_COUNT } from "common";
    ...
    <HelpfulCheckbox
      ...
      helpContent={
        <span className={POKEMON_PIXEL_FONT.className} css={tw`text-base`}>
          Enabling Turbo A/B and voting for A/B will send in a vote to press A/B{" "}
          <span css={tw`font-bold`}>{TURBO_AB_PRESS_COUNT} times</span>
        </span>
      }
    >
      Turbo A/B
